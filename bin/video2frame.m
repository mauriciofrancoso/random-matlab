...
mkdir(PathName,'leftImg0'); %you have to change the new folder name you'e creating
...
while hasFrame(VIDEO)
   ...
   filename_Gray = [sprintf('leftImg0_%0.0d',i) '.jpg']; %you have to change the name of file you're creating
   fullname_Gray = fullfile(PathName,'leftImg0',filename_Gray); %same here
